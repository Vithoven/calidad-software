        ...
        if (validarCorreosuario()) {
            if (validarContraseñaUsuario()) {
                ...
                if (correo.includes("@gmail.com") ) {
                    $("#ini_f_c").attr("action", "vet/html/index_login.html"); // Redirigir al usuario 1 a la página 1
                } else if (correo.includes( "@trabajador.com")) {
                    $("#ini_f_c").attr("action", "vet/html/trabajador.html"); // Redirigir al usuario 2 a la página 2
