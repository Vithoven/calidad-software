...
SECRET_KEY = 'django-insecure-y63rj@@t5t&ag1_$e8)owp3h&j=b8s$h(6rw(_z+@sycx5u&lm'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'mi_web.context_processors.carrito',
            ],
        },
    },
]
...
MEDIA_URL='/media/'
import os
MEDIA_ROOT=os.path.join(BASE_DIR,'mi_web/media')

AUTH_USER_MODEL='mi_web.Usuario'
